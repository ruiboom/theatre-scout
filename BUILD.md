...
| M1 | Theatre data + models | 1 h | `theatres.yaml` validates and loads into 80 `Theatre` objects |
...
- categories ∈ `{major, mid, fringe, outer}` with counts `{18, 21, 29, 12}`
...
- All 80 adapters present, each with a fixture and parse test.
